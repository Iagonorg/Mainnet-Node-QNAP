...
7. For Auth Key Regeneration <br/>
...
8. You can try again from start if something went wrong.
    a. For this click on "Restart Setup". Then it will prompt you to this form. <br/>
        ![reset-setup](./assets/reset-setup.png)


9. You can stop the node by clicking in the stop button in the options.
...
10. You can remove the application as well from the remove option.
